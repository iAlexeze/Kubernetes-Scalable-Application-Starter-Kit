...
2. Ensure that you have a Kubernetes cluster up and running. If you don't have a cluster, you can create one using tools like [Minikube](https://minikube.sigs.k8s.io/) or [Kind](https://kind.sigs.k8s.io/). I have provided a configuration to setup a multi-node kind Cluster<a name="cluster-configuration"></a>
